...
public class SingleChannelPlot {
    ...
    public SingleChannelPlot(final String title, final String[][] _rawdata) {
        rawdata = _rawdata;
        i=0;
...
//    		channelData = new float[rawdata.length];
//	        for(int i=0; i<rawdata.length-1;i++){
//	        	channelData[i] = Float.valueOf(rawdata[i][j+1]);
//	        	//System.out.println("in for loop" + channelData[i]);
//	        }
//	        dataset.addSeries(buf,i, "Gaussian data");  
//    	}
