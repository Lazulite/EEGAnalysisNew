...
import com.lw.eeg.plot.SingleLineChartPlot;
...
public class ChannelButtonsFFT implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand()!="HR"){
			...
			singleLineChartPlot.setPanel(singlefftPanel);
			singleLineChartPlot.setData(totalData.get(Arrays.asList(chName).indexOf(e.getActionCommand())));
			if(!click){
			ChartPanel singleChannelp = new ChartPanel(singleLineChartPlot.getChart());
			singlefftPanel.add(singleChannelp, BorderLayout.CENTER);
